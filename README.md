...
Heart disease remains one of the leading causes of death globally. Early detection can significantly improve prevention and treatment outcomes.
The objective of this project is to build a classification model that predicts whether a patient is likely to have heart disease based on their medical attributes.


## 🧩 Project Phases

Data Cleaning and Exploration – Understanding the dataset and preparing it for modeling.
...
This project strengthened our understanding of end-to-end data science workflows — from data preparation to machine learning modeling — and showcased how data-driven insights can be applied to real-world healthcare problems.
